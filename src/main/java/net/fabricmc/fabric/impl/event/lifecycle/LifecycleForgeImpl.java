...
public final class LifecycleForgeImpl {
    ...
    public static void onTagsLoaded(@NotNull TagsUpdatedEvent event) {
        CommonLifecycleEvents.TAGS_LOADED.invoker().onTagsLoaded(event.getTagManager(), event.getUpdateCause().equals(TagsUpdatedEvent.UpdateCause.CLIENT_PACKET_RECEIVED));
    }
