...
public class ContentRegistryForgeImpl {
            ...
            if (pair != null) {
                ...
                if (pair.getFirst().test(context)) {
                    if (event.isSimulated()) {
                        ...
                        ItemUsageContext readOnlyContext = new ItemUsageContext(readOnlyView, context.getPlayer(), context.getHand(), context.getStack(), context.hit);
