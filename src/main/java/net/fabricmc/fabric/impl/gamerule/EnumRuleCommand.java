...
public final class EnumRuleCommand {
	public static <E extends Enum<E>> void register(@NotNull LiteralArgumentBuilder<ServerCommandSource> literalArgumentBuilder, GameRules.@NotNull Key<EnumRule<E>> key, @NotNull EnumRuleType<E> type) {
	...
	public static <E extends Enum<E>> int executeAndSetEnum(@NotNull CommandContext<ServerCommandSource> context, E value, GameRules.Key<EnumRule<E>> key) throws CommandSyntaxException {
