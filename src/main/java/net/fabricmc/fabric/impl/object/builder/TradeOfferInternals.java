...
public final class TradeOfferInternals {
	private static final Map<VillagerProfession, Int2ObjectMap<List<TradeOffers.Factory>>> VILLAGER_TRADES = new Object2ObjectOpenHashMap<>();
	...
	public static synchronized void registerVillagerOffers(VillagerProfession profession, int level, Consumer<List<TradeOffers.Factory>> factory) {
		...
		registerOffers(VILLAGER_TRADES.computeIfAbsent(profession, key -> new Int2ObjectOpenHashMap<>()), level, factory);
	}
