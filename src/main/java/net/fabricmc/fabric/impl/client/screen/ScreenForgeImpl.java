...
public final class ScreenForgeImpl {
    @SubscribeEvent
    public static void onClosing(ScreenEvent.@NotNull Closing event) {
        Screen screen = event.getScreen();
        ScreenEvents.remove(screen).invoker().onRemove(screen);
    }

    @SubscribeEvent
    public static void beforeKeyPressedEvent(ScreenEvent.KeyPressed.@NotNull Pre event) {
        Screen screen = event.getScreen();
    ...
    @SubscribeEvent
    public static void afterKeyPressedEvent(ScreenEvent.KeyPressed.@NotNull Post event) {
        Screen screen = event.getScreen();
    ...
    @SubscribeEvent
    public static void beforeKeyReleased(ScreenEvent.KeyReleased.@NotNull Pre event) {
        Screen screen = event.getScreen();
        int keyCode = event.getKeyCode();
        int scanCode = event.getScanCode();
        int modifiers = event.getModifiers();
    ...
    @SubscribeEvent
    public static void afterKeyReleased(ScreenEvent.KeyReleased.@NotNull Post event) {
        Screen screen = event.getScreen();
    ...
    @SubscribeEvent
    public static void beforeMouseClickedEvent(ScreenEvent.MouseButtonPressed.@NotNull Pre event) {
        Screen screen = event.getScreen();
    ...
    @SubscribeEvent
    public static void afterMouseClickedEvent(ScreenEvent.MouseButtonPressed.@NotNull Post event) {
        Screen screen = event.getScreen();
        ScreenMouseEvents.afterMouseClick(screen).invoker().afterMouseClick(screen, event.getMouseX(), event.getMouseY(), event.getButton());
    }

    @SubscribeEvent
    public static void beforeMouseReleased(ScreenEvent.MouseButtonReleased.@NotNull Pre event) {
        Screen screen = event.getScreen();
        double mouseX = event.getMouseX();
        double mouseY = event.getMouseX();
        int button = event.getButton();
    ...
    @SubscribeEvent
    public static void afterMouseReleased(ScreenEvent.MouseButtonReleased.@NotNull Post event) {
        Screen screen = event.getScreen();
    ...
    @SubscribeEvent
    public static void beforeMouseScroll(ScreenEvent.MouseScrolled.@NotNull Pre event) {
        Screen screen = event.getScreen();
        double mouseX = event.getMouseX();
        double mouseY = event.getMouseX();
    ...
    @SubscribeEvent
    public static void afterMouseScroll(ScreenEvent.MouseScrolled.@NotNull Post event) {
        Screen screen = event.getScreen();
