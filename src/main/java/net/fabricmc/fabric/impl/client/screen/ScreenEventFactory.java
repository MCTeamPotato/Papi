...
public final class ScreenEventFactory {
	public static @NotNull Event<ScreenEvents.Remove> createRemoveEvent() {
	...
	public static @NotNull Event<ScreenEvents.BeforeRender> createBeforeRenderEvent() {
	...
	public static @NotNull Event<ScreenEvents.AfterRender> createAfterRenderEvent() {
	...
	public static @NotNull Event<ScreenEvents.BeforeTick> createBeforeTickEvent() {
	...
	public static @NotNull Event<ScreenEvents.AfterTick> createAfterTickEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.AllowKeyPress> createAllowKeyPressEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.BeforeKeyPress> createBeforeKeyPressEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.AfterKeyPress> createAfterKeyPressEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.AllowKeyRelease> createAllowKeyReleaseEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.BeforeKeyRelease> createBeforeKeyReleaseEvent() {
	...
	public static @NotNull Event<ScreenKeyboardEvents.AfterKeyRelease> createAfterKeyReleaseEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AllowMouseClick> createAllowMouseClickEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.BeforeMouseClick> createBeforeMouseClickEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AfterMouseClick> createAfterMouseClickEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AllowMouseRelease> createAllowMouseReleaseEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.BeforeMouseRelease> createBeforeMouseReleaseEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AfterMouseRelease> createAfterMouseReleaseEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AllowMouseScroll> createAllowMouseScrollEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.BeforeMouseScroll> createBeforeMouseScrollEvent() {
	...
	public static @NotNull Event<ScreenMouseEvents.AfterMouseScroll> createAfterMouseScrollEvent() {
