...
public class ForgeCustomIngredientSerializer implements IIngredientSerializer<CustomIngredientImpl> {
    ...
    @Override
    public @NotNull CustomIngredientImpl parse(@NotNull PacketByteBuf buf) {
        return (CustomIngredientImpl) this.serializer.read(buf).toVanilla();
    }

    @Override
    public @NotNull CustomIngredientImpl parse(@NotNull JsonObject json) {
        return (CustomIngredientImpl) this.serializer.read(json).toVanilla();
    }

    @Override
    public void write(@NotNull PacketByteBuf buf, CustomIngredientImpl ingredient) {
