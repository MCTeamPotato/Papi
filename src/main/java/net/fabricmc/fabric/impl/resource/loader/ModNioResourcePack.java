...
public class ModNioResourcePack extends AbstractFileResourcePack implements ModResourcePack {
	...
	public ModNioResourcePack(ModInfo modInfo, Path path, AutoCloseable closer, ResourcePackActivationType activationType) {
		super(null);
	...
	protected void warnInvalidNamespace(String s) {
		LOGGER.warn("Fabric NioResourcePack: ignored invalid namespace: {} in mod ID {}", s, modInfo.getModId());
	}
	...
	public Set<String> getNamespaces(ResourceType type) {
		...
		try {
			...
			LOGGER.warn("getNamespaces in mod " + modInfo.getModId() + " failed!", e);
			return Collections.emptySet();
		}
	}
	...
	@Override
	public ModInfo getFabricModMetadata() {
		return modInfo;
	}
