...
public final class ResourceConditionsImpl {
	...
	public static @NotNull ConditionJsonProvider array(Identifier id, ConditionJsonProvider @NotNull ... values) {
	...
	public static boolean tagsPopulatedMatch(JsonObject object, RegistryKey<? extends Registry<?>> registryKey) {
		...
		if (allTags == null) {
			Papi.LOGGER.warn("Can't retrieve deserialized tags. Failing tags_populated resource condition check.");
			return false;
		}
