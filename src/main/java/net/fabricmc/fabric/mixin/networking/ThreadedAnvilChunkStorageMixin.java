...
public abstract class ThreadedAnvilChunkStorageMixin implements ThreadedAnvilChunkStorageTrackingExtensions {
	@Shadow
	@Final
	...
	public Collection<ServerPlayerEntity> fabric_getTrackingPlayers(Entity entity) {
		ThreadedAnvilChunkStorage.EntityTracker accessor = this.entityTrackers.get(entity.getEntityId());

		if (accessor != null) {
			return ((EntityTrackerAccessor)accessor).getPlayersTracking();
		}
