...
public final class FabricDefaultAttributeRegistry {
	...
	public static void register(EntityType<? extends LivingEntity> type, DefaultAttributeContainer container) {
		if (ObjectBuilderForgeImpl.register(type, container) != null) {
			LOGGER.debug("Overriding existing registration for entity type {}", ForgeRegistries.ENTITY_TYPES.getKey(type));
		}
	}
}
