...
public final class FabricParticleTypes {
	 ...
	 */
	@Contract(" -> new")
	public static @NotNull DefaultParticleType simple() {
		return simple(false);
	}
	...
	public static <T extends ParticleEffect> @NotNull ParticleType<T> complex(ParticleEffect.Factory<T> factory) {
	...
	public static <T extends ParticleEffect> @NotNull ParticleType<T> complex(boolean alwaysSpawn, ParticleEffect.Factory<T> factory) {
