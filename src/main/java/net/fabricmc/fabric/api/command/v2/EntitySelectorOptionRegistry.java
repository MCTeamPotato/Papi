...
public final class EntitySelectorOptionRegistry {
	 ...
	 */
	public static void register(@NotNull Identifier id, Text description, EntitySelectorOptions.SelectorHandler handler, Predicate<EntitySelectorReader> canUse) {
