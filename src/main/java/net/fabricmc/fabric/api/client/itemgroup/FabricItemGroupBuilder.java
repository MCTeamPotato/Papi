...
public final class FabricItemGroupBuilder {
	...
	public static @NotNull FabricItemGroupBuilder create(Identifier identifier) {
	 ...
	 */
	public static @NotNull ItemGroup build(Identifier identifier, Supplier<ItemStack> stackSupplier) {
	 ...
	 * @return an instance of the built ItemGroup
	 */
	public @NotNull ItemGroup build() {
