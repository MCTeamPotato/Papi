...
public interface FabricSoundInstance {
	 ...
	 */
	Identifier EMPTY_SOUND = new Identifier("fabric_sound_api_v1", "empty");
	 ...
	 */
	default CompletableFuture<AudioStream> getAudioStream(@NotNull SoundLoader loader, Identifier id, boolean repeatInstantly) {
