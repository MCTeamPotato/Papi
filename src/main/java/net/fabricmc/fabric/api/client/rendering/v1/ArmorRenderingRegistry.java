...
public final class ArmorRenderingRegistry {
	...
	public static void registerSimpleTexture(Identifier identifier, Item... items) {
		registerTexture((entity, stack, slot, secondLayer, suffix, defaultTexture) -> new Identifier(identifier.getNamespace(), "textures/models/armor/" + identifier.getPath() + "_layer_" + (secondLayer ? 2 : 1) + (suffix == null ? "" : "_" + suffix) + ".png"), items);
	}
