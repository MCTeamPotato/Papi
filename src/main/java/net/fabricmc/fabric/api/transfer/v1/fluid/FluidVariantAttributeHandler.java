...
public interface FluidVariantAttributeHandler {
	 ...
	 *
	 * <p>If a non-empty sound event is returned, BucketItem#playEmptyingSound will play that sound.
	 */
	 ...
	 *
	 * <p>More precisely, viscosity should be {@value FluidConstants#VISCOSITY_RATIO} * FlowableFluid#getFlowSpeed for flowable fluids.
