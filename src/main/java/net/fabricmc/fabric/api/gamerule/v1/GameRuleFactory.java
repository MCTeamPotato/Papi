...
public final class GameRuleFactory {
	...
	public static GameRules.@NotNull Type<DoubleRule> createDoubleRule(double defaultValue, double minimumValue) {
	...
	public static GameRules.@NotNull Type<DoubleRule> createDoubleRule(double defaultValue, double minimumValue, BiConsumer<MinecraftServer, DoubleRule> changedCallback) {
	 ...
	 */
	@Contract(value = "_, _, _ -> new", pure = true)
	public static GameRules.@NotNull Type<DoubleRule> createDoubleRule(double defaultValue, double minimumValue, double maximumValue) {
	 ...
	 */
	@Contract(value = "_, _ -> new", pure = true)
	public static GameRules.@NotNull Type<DoubleRule> createDoubleRule(double defaultValue, BiConsumer<MinecraftServer, DoubleRule> changedCallback) {
	...
	public static GameRules.@NotNull Type<DoubleRule> createDoubleRule(double defaultValue, double minimumValue, double maximumValue, BiConsumer<MinecraftServer, DoubleRule> changedCallback) {
		return new GameRules.Type<>(
	 ...
	 */
	@Contract("_ -> new")
	public static <E extends Enum<E>> GameRules.@NotNull Type<EnumRule<E>> createEnumRule(E defaultValue) {
	 ...
	 */
	@Contract("_, _ -> new")
	public static <E extends Enum<E>> GameRules.@NotNull Type<EnumRule<E>> createEnumRule(E defaultValue, BiConsumer<MinecraftServer, EnumRule<E>> changedCallback) {
	 ...
	 */
	@Contract("_, _ -> new")
	public static <E extends Enum<E>> GameRules.@NotNull Type<EnumRule<E>> createEnumRule(E defaultValue, E[] supportedValues) {
	 ...
	 */
	@Contract("_, _, _ -> new")
	public static <E extends Enum<E>> GameRules.@NotNull Type<EnumRule<E>> createEnumRule(E defaultValue, E[] supportedValues, BiConsumer<MinecraftServer, EnumRule<E>> changedCallback) {
