...
public interface FabricItem extends IForgeItem {
	...
	// PAPI: Forge default implementation
	...
	default ItemStack getContainerItem(ItemStack stack) {
		...
		return IForgeItem.super.hasContainerItem(stack) ? new ItemStack(((Item) this).getRecipeRemainder()) : ItemStack.EMPTY;
	}

	@Override
	default boolean hasContainerItem(ItemStack stack) {
		return !FabricItemInternals.nonRecursiveApiCall(() -> getRecipeRemainder(stack)).isEmpty() || IForgeItem.super.hasContainerItem(stack);
	}
