...
import net.fabricmc.papi.api.event.registry.RegistryAttribute;
import net.fabricmc.papi.api.event.registry.RegistryAttributeHolder;
import net.fabricmc.papi.impl.registry.sync.FabricRegistry;
