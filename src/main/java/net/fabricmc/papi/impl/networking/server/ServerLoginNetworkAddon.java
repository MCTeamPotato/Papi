...
package net.fabricmc.papi.impl.networking.server;

import io.netty.util.concurrent.GenericFutureListener;
import net.fabricmc.papi.api.networking.v1.PacketByteBufs;
import net.fabricmc.papi.api.networking.v1.PacketSender;
import net.fabricmc.papi.api.networking.v1.ServerLoginConnectionEvents;
import net.fabricmc.papi.api.networking.v1.ServerLoginNetworking;
import net.fabricmc.papi.impl.networking.AbstractNetworkAddon;
import net.fabricmc.papi.mixin.networking.accessor.LoginQueryRequestS2CPacketAccessor;
import net.fabricmc.papi.mixin.networking.accessor.LoginQueryResponseC2SPacketAccessor;
import net.fabricmc.papi.mixin.networking.accessor.ServerLoginNetworkHandlerAccessor;
...
public final class ServerLoginNetworkAddon extends AbstractNetworkAddon<ServerLoginNetworking.LoginQueryResponseHandler> implements PacketSender {
	...
	public void registerOutgoingPacket(LoginQueryRequestS2CPacket packet) {
		...
		if (WRAPPER.equals(access.getChannel())) {
			this.ignoredChannels.put(access.getServerQueryId(), access.getChannel());
			return;
		}
