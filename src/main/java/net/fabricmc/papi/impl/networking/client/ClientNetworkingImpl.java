...
package net.fabricmc.papi.impl.networking.client;
...
import net.fabricmc.papi.api.client.networking.v1.ClientLoginNetworking;
import net.fabricmc.papi.api.client.networking.v1.ClientPlayConnectionEvents;
import net.fabricmc.papi.api.client.networking.v1.ClientPlayNetworking;
import net.fabricmc.papi.api.networking.v1.PacketByteBufs;
import net.fabricmc.papi.impl.networking.ChannelInfoHolder;
import net.fabricmc.papi.impl.networking.GlobalReceiverRegistry;
import net.fabricmc.papi.impl.networking.NetworkHandlerExtensions;
import net.fabricmc.papi.impl.networking.NetworkingImpl;
import net.fabricmc.papi.mixin.networking.accessor.ConnectScreenAccessor;
import net.fabricmc.papi.mixin.networking.accessor.MinecraftClientAccessor;
