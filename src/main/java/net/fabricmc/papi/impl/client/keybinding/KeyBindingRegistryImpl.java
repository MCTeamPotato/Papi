...
package net.fabricmc.papi.impl.client.keybinding;

import com.google.common.collect.Lists;
import it.unimi.dsi.fastutil.objects.ReferenceArrayList;
import net.fabricmc.papi.mixin.client.keybinding.KeyBindingAccessor;
...
public final class KeyBindingRegistryImpl {
    ...
    public static void registerKeys(FMLClientSetupEvent event) {
        for (KeyBinding keyBinding : MODDED_KEY_BINDINGS) event.enqueueWork(() -> ClientRegistry.registerKeyBinding(keyBinding));
    }
}